class PriceList < ActiveRecord::Base
  ...
  def create_product_price(product_hash)
    ...
    price_model = self.prices.new(price_per_unit:price)
       # TODO: make a gluten-free check
    ...
    price_model.product = product
  end

  def remove_dublicats
