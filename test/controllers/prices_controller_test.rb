...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { price_list_id: @price.price_list_id, price_per_unit: @price.price_per_unit, product_id: @price.product_id }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { price_list_id: @price.price_list_id, price_per_unit: @price.price_per_unit, product_id: @price.product_id }
    assert_redirected_to price_path(assigns(:price))
  end
